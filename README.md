...
🚀 Over **12 years** of experience building scalable SaaS platforms, admin panels, and custom tools.

- 🔭 I specialize in **Laravel**, **Filament**, and modern PHP ecosystems
- 🛠️ I build **SaaS platforms**, **admin panels**, and **custom developer tools**
- 📦 Author of multiple **Filament plugins** for the open-source community
